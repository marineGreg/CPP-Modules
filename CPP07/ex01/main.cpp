...
int main() {
	...
	std::cout << "Avant decrement : ";
	iter(tabDouble, 5, printItem<double>);
	std::cout << std::endl;
    ...
    iter(tabStr, 5, printItem<std::string>);
    std::cout << std::endl;
    ...
    iter(tabConst, 5, printItem<const int>);
    std::cout << std::endl;
